...
const content = {
  ...
  content: {
    ...
    errors: {
      grantFailed: t({ ru: 'Не удалось предоставить доступ', en: 'Failed to grant access', kk: 'Қолжетімділік беру мүмкін болмады' }),
      updateFailed: t({ ru: 'Не удалось обновить права', en: 'Failed to update permissions', kk: 'Құқықтарды жаңарту мүмкін болмады' }),
    },
    table: {
    ...
    permission: {
      ...
      viewDownloadLong: t({ ru: 'Просмотр и скачивание', en: 'View and download', kk: 'Қарау және жүктеу' }),
      default: t({ ru: 'Права', en: 'Permissions', kk: 'Құқықтар' }),
    },
    dialogs: {
      grantTitle: t({ ru: 'Предоставить доступ', en: 'Grant access', kk: 'Қолжетімділік беру' }),
      editTitle: t({ ru: 'Редактировать права доступа', en: 'Edit permissions', kk: 'Қолжетімділік құқықтарын өзгерту' }),
      userIdOrEmail: t({ ru: 'Email или ID пользователя', en: 'User email or ID', kk: 'Пайдаланушы email немесе ID' }),
      userIdOrEmailHelp: t({
      ...
      reshare: t({ ru: 'Разрешить делиться с другими', en: 'Allow sharing with others', kk: 'Басқалармен бөлісуге рұқсат беру' }),

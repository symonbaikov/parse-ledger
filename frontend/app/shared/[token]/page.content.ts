...
const content = {
  ...
  content: {
    ...
    errors: {
      ...
      loadFailed: t({ ru: 'Не удалось загрузить файл', en: 'Failed to load file', kk: 'Файлды жүктеу мүмкін болмады' }),
    ...
    protected: {
      ...
      subtitle: t({ ru: 'Для доступа к этому файлу требуется пароль', en: 'Password is required to access this file', kk: 'Бұл файлға кіру үшін құпиясөз қажет' }),

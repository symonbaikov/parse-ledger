...
const content = {
  ...
  content: {
    ...
    labels: {
      ...
      editColumnButton: t({ ru: 'Редактировать', en: 'Edit', kk: 'Өзгерту' }),
      editColumnTitle: t({ ru: 'Редактировать колонку', en: 'Edit column', kk: 'Бағанды өзгерту' }),
      create: t({ ru: 'Создать', en: 'Create', kk: 'Құру' }),
      saveChanges: t({ ru: 'Сохранить изменения', en: 'Save changes', kk: 'Өзгерістерді сақтау' }),
      ...
      paginationPrev: t({ ru: 'Предыдущая', en: 'Prev', kk: 'Артқа' }),
      paginationNext: t({ ru: 'Следующая', en: 'Next', kk: 'Алға' }),
      paginationPageShort: t({ ru: 'Страница', en: 'Page', kk: 'Бет' }),
    ...
    errors: {
      ...
      updateColumnFailed: t({
        ru: 'Не удалось обновить колонку',
        en: 'Failed to update column',
        kk: 'Бағанды жаңарту мүмкін болмады',
      }),

  ...
  content: {
    ...
    tabs: {
      cash: {
        ...
        description: t({ ru: 'Остатки наличных средств.', en: 'Cash balance.', kk: 'Қолма-қол қалдық.' }),
      },
      raw: {
      ...
      debit: {
        ...
        description: t({ ru: 'Дебетовые операции / приход.', en: 'Debit operations / income.', kk: 'Дебет операциялары / кіріс.' }),
      },
      credit: {
        label: t({ ru: 'Кредит', en: 'Credit', kk: 'Кредит' }),
        description: t({ ru: 'Кредитовые операции / расход.', en: 'Credit operations / expense.', kk: 'Кредит операциялары / шығыс.' }),
      },
      custom: {
    ...
    labels: {
      ...
      dataEntryForTabPrefix: t({ ru: 'Ввод данных для вкладки «', en: 'Data entry for tab “', kk: 'Қойынды үшін деректер енгізу «' }),
      ...
      noColumnsYet: t({ ru: 'Пока нет созданных колонок', en: 'No columns created yet', kk: 'Әзірге жасалған бағандар жоқ' }),
      ...
      recentEntriesTitlePrefix: t({ ru: 'Последние записи — ', en: 'Recent entries — ', kk: 'Соңғы жазбалар — ' }),
      recentEntriesHint: t({
      ...
      tabHasDataPrefix: t({ ru: 'Внутри есть данные (', en: 'This tab contains data (', kk: 'Ішінде деректер бар (' }),
      tabHasDataSuffix: t({
      ...
      tabNoData: t({ ru: 'Данных нет — вкладка будет удалена.', en: 'No data — the tab will be deleted.', kk: 'Деректер жоқ — қойынды жойылады.' }),
      copying: t({ ru: 'Копирование…', en: 'Copying…', kk: 'Көшірілуде…' }),
      copyAndDelete: t({ ru: 'Скопировать в таблицу и удалить', en: 'Copy to table and delete', kk: 'Кестеге көшіріп, жою' }),
    ...
    errors: {
      ...
      fillDateAndAmount: t({ ru: 'Заполните дату и сумму', en: 'Fill in date and amount', kk: 'Күн мен соманы толтырыңыз' }),
      amountMustBeNumber: t({ ru: 'Сумма должна быть числом', en: 'Amount must be a number', kk: 'Сома сан болуы керек' }),
      saveFailed: t({ ru: 'Не удалось сохранить данные', en: 'Failed to save data', kk: 'Деректерді сақтау мүмкін болмады' }),
      loadEntriesFailed: t({ ru: 'Не удалось загрузить записи', en: 'Failed to load entries', kk: 'Жазбаларды жүктеу мүмкін болмады' }),
      ...
      columnNameRequired: t({ ru: 'Укажите название колонки', en: 'Enter column name', kk: 'Баған атауын көрсетіңіз' }),
      createColumnFailed: t({ ru: 'Не удалось создать колонку', en: 'Failed to create column', kk: 'Бағанды құру мүмкін болмады' }),
      deleteColumnFailed: t({ ru: 'Не удалось удалить колонку', en: 'Failed to delete column', kk: 'Бағанды жою мүмкін болмады' }),
      copyToTableFailed: t({ ru: 'Не удалось скопировать в таблицу', en: 'Failed to copy to table', kk: 'Кестеге көшіру мүмкін болмады' }),
      deleteTabFailed: t({ ru: 'Не удалось удалить вкладку', en: 'Failed to delete tab', kk: 'Қойындыны жою мүмкін болмады' }),
      uploadIconFailed: t({ ru: 'Не удалось загрузить иконку', en: 'Failed to upload icon', kk: 'Белгішені жүктеу мүмкін болмады' }),
      syncFailed: t({ ru: 'Не удалось синхронизировать', en: 'Failed to sync', kk: 'Синхрондау мүмкін болмады' }),
      createTableFailed: t({ ru: 'Не удалось создать таблицу', en: 'Failed to create table', kk: 'Кесте жасау мүмкін болмады' }),
      deleteEntryFailed: t({ ru: 'Не удалось удалить запись', en: 'Failed to delete entry', kk: 'Жазбаны жою мүмкін болмады' }),
    },
    status: {
      ...
      columnCreated: t({ ru: 'Пользовательская колонка создана', en: 'Custom column created', kk: 'Пайдаланушы бағаны құрылды' }),

...
import { AlertCircle, ArrowDown, ArrowUp, Download, RefreshCcw, TrendingUp } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-secondary mt-1">
            Сводка приходов, расходов и чистого потока по данным из Google Sheets.
          </p>
        </div>

...
const content = {
  ...
  content: {
    errors: {
      ...
      sheetIdRequired: t({
        ru: 'Введите ID таблицы Google Sheet',
        en: 'Enter the Google Sheet ID',
        kk: 'Google Sheet ID енгізіңіз',
      }),
      connectFailed: t({
    ...
    fields: {
      ...
      sheetIdPlaceholder: t({
        ru: 'Например: 1AbCdEf...',
        en: 'e.g. 1AbCdEf...',
        kk: 'Мысалы: 1AbCdEf...',
      }),
      connectionName: t({
        ru: 'Название подключения (опционально)',
        en: 'Connection name (optional)',
        kk: 'Қосылым атауы (міндетті емес)',
      }),
      connectionNamePlaceholder: t({
        ru: 'Например: Финансы 2025',
        en: 'e.g. Finance 2025',
        kk: 'Мысалы: Қаржы 2025',
      }),
      worksheet: t({
        ru: 'Лист (опционально)',
        en: 'Worksheet (optional)',
        kk: 'Парақ (міндетті емес)',
      }),

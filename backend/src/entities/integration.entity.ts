...
export class Integration {
  ...
  @OneToOne(() => IntegrationToken, (token) => token.integration)
  token: IntegrationToken | null;

  @OneToOne(() => DriveSettings, (settings) => settings.integration)
  driveSettings: DriveSettings | null;

  @OneToOne(() => DropboxSettings, (settings) => settings.integration)

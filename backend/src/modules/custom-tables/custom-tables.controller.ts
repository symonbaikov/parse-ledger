...
export class CustomTablesController {
  ...
  async createFromDataEntry(
    ...
    const table = await this.customTablesService.createFromDataEntry(
      user.id,
      dto,
    );
    await this.customTablesCache.bumpList(user.id);
  ...
  async createFromStatements(
    ...
    const table = await this.customTablesService.createFromStatements(
      user.id,
      dto,
    );
    await this.customTablesCache.bumpList(user.id);
  ...
  async addColumn(
    ...
    const column = await this.customTablesService.addColumn(
      user.id,
      tableId,
      dto,
    );
  ...
  async updateRow(
    ...
    const row = await this.customTablesService.updateRow(
      user.id,
      tableId,
      rowId,
      dto,
